      ...
      <div className="flex-1">
        <div className="flex gap-2 mb-2 justify-between">
          ...
          <button
            ...
            className="rounded bg-red-200 text-red px-2 hover:bg-red-600 hover:text-white"
          >
            x
          </button>
        </div>
...
const CreateBlog = () => {
  ...
  const handleAddParagraph = () => {
    setParagraphs([...paragraphs, { id: `para-${paragraphs.length + 1}`, content: '' }]);
  };
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <div className="flex flex-row justify-between mb-2">
                <label className="block text-sm font-medium text-gray-900">Blog Content</label>
                <button
                  type="button"
                  ...
                  {(provided) => (
                    <div {...provided.droppableProps} ref={provided.innerRef}>
                      {paragraphs.map((para, index) => (
                        <Draggable key={para.id} draggableId={para.id} index={index}>
                          {(provided) => (
                            <ParagraphEditor
        ...
        <div className="lg:w-1/2 bg-gray-50 p-6 rounded-lg shadow-md">
          ...
          <div className="prose max-w-none">
            {paragraphs.map((para, index) => (
              <div
                key={index}
                dangerouslySetInnerHTML={{ __html: para.content || '<p>Start typing your paragraph...</p>' }}
                className="mb-4"
              />
            ))}
          </div>
