    ...
    <>
      ...
      <section className="page_paragraph" data-aos="fade-up">
        ...
        <p className="page_paragraph_paragraph">
          ...
          accommodations. Embark on a memorable pilgrimage with Saudi Hop, your
          ...
          <div className="row y-gap-40 justify-between">
            <div className="col-xl-6 col-lg-6 p-0 bg-blue-2">
              <h1 className="content_left_col">
                Saudi Hop: Your Premier Choice for Pilgrimage Travel Services at
                Unbeatable Prices
              </h1>
            </div>
            {/* End col */}
            ...
            <div className="col-lg-6">
              ...
              >
                ...
                <p className="content_right_col_paragraph">
                  ...
                  in selecting the best options for your pilgrimage, ensuring a
                  seamless journey to the holy cities of Makkah and Medina.
                  Committed to affordability and convenience, Saudi Hop makes
                  the sacred pilgrimage accessible to all. Trust Saudi Hop for a
                  memorable and fulfilling Umrah experience.
                </p>
              </div>
            </div>
          </div>
