...
import SingleLuxuryPackageHotels from "@/components/Packages/Single_Luxury_Package_Hotels";
import UploadFiles from "@/features/fileSlice";

const LuxurySinglePackage = () => {
  const [packageImages, setPackageImages] = useState({})
  let params = useParams();
  const id = params.id;
  // const requiredPackage = ultraLuxuryPackagesData.find((item) => item.id == id);
  ...
  const metadata = {
    ...
    description: `${
      ...
      ", "
    )}. Experience the pinnacle of luxury with exclusive services for a seamless pilgrimage.`,
    keywords: `${
      requiredPackage.title
    }, Ultra-Luxury Umrah Package, ${requiredPackage.highlights.join(
      ", "
    )}, Premium Umrah Services, Exclusive Pilgrimage, Saudi Hop`,
  };
          ...
          <div className="row y-gap-30">
            <div className="col-md-7">
              <div className="row y-gap-40">
                ...
                <div className="col-12">
                  <div className="px-24 py-20 rounded-4 bg-gray-900">
                ...
                <div className="px-30 py-30 border-light rounded-4 shadow-4">
                  <div className="d-flex items-center justify-between">
                    ...
                    <div className="d-flex items-center">
                      ...
                      <div className="size-40 flex-center bg-gray-900 rounded-4">
                  ...
                  <div className="row y-gap-20 pt-30">
                    ...
                    <div className="col-12">
                      <div className="button-item h-full">
                        <button
                          className="button px-35 h-60 col-12 luxury_single_package_book_now_button"
                          style={{ fontSize: "16px" }}
                        >
                          Book Now
                        </button>
      ...
      <section className="layout-pt-md layout-pb-lg mt-0 md:mt-20">
        <div className="container">
          <div className="row justify-center text-center">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">Hotels in this Package</h2>
              </div>
              {/* End sectionTitle */}
            </div>
            {/* End .col */}
          ...
          <div className="pt-40 sm:pt-20 item_gap-x30">
            <SingleLuxuryPackageHotels hotelIds={requiredPackage.hotels} />
          </div>
          {/* End slide hotel */}
        </div>
        {/* End .container */}
...
export default LuxurySinglePackage;
